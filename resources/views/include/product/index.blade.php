                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('product.store') }}" method="post" id="formAddcategory"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($listProduct as $index=>$item)
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td></td> --}}
                                                <td>{{ $item['code'] }}</td>
                                                <td><img src="{{$item['image']}}" alt="" style="max-width:200px; max-height: 200px"></td>
                                                <td>{{ $item['name']}}</td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="p-5">
                                                                <div class="text-left">
                                                                    <h1 class="h4 text-gray-900 mb-4">Bạn có muốn xoá sản phẩm này?</h1>
                                                                    <div class="modal-body">
                                          ...
                                          <div class="modal fade" id="update{{ $item['id'] }}">
                                            <div class="modal-dialog modal-dialog-centered ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('product.update', ['id' => $item['id']]) }}"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="category_id" id="" class="form-control">
                                                                                ...
                                                                                @foreach ($category as $cate2)
                                                                                    <option value="{{$cate2['id']}}" @if($item['category_id'] == $cate2['id']) {{'selected'}} @endif>{{ $cate2['title']}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                            ...
                                                                            <label for="">Ảnh</label>
                                                                            <input type="file" class="form-control" name="image">
                                                                            <img src="{{ $item['image']}}" alt="" style="max-width:200px; max-height: 200px">
                                                                        </div>
                                                                    </div>
